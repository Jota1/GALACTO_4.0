Shader "NatureManufacture Shaders/Water/Water Stylized Offset Vertex Color Flow"
{
	Properties
	{
		...
		_BigCascadeNoiseMultiply("Big Cascade Noise Multiply", Range( 0 , 10)) = 2.71
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float lerpResult1459 = lerp( temp_output_114_0 , 0.0 , clampResult514);
			float clampResult1454 = clamp( lerpResult1459 , 0.0 , 1.0 );
